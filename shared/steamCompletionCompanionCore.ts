// shared/steamCompletionCompanionCore.ts
...
export function rgbaColorToCss(color: RgbaColor, alpha?: number): string {
...
export function cssColorLooksUseful(value: string): boolean {
...
export function cssColorIsTooGenericDark(value: string): boolean {
  const rgb = parseRgbaColor(value);
...
export function getUsefulCssStyleColor(
